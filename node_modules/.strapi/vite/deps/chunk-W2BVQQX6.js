...
import {
  ...
  HOOKS
} from "./chunk-Z2WITKKP.js";
import {
  useNpsSurveySettings
} from "./chunk-Y3DCOTWG.js";
import {
  GuidedTourContext
} from "./chunk-5BYLUZYR.js";
import {
  require_pick
} from "./chunk-NVUTQB3F.js";
import {
  getBasename
...
import {
  useEnterprise
} from "./chunk-H45UCNRM.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-2NUDFG4Q.js";
import {
  Login
} from "./chunk-D4S2DQ2W.js";
import {
  MemoizedInputRenderer
} from "./chunk-JTRLDA6C.js";
import {
  Form
} from "./chunk-PDI6QYSX.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-5HSBFO2D.js";
import {
  ConfigurationProvider
} from "./chunk-LFJLSOS7.js";
import {
  require_baseMerge,
...
import {
  TrackingProvider,
  useTracking
} from "./chunk-PHGX2PLY.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-7QKL2ZA7.js";
import {
  getByteSize
...
} from "./chunk-NULKCHIY.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-225ITR2O.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-KRDNB6QE.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-4UTUW7PN.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-7MVW4JCZ.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-UJAT7FW4.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-3FTGEKSU.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-M7MSG3XZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-SR3BRI6U.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-LSCWJ5CD.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-IYOT5RCD.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-UCQOGQWR.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-KHMZIDON.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-MEI4END3.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-HZCNVWID.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-RQ2WWBTQ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-NGO7LC44.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-AZIFVHI7.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-RNRCY7PW.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-LCDWBLQJ.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-TXAO234Y.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-XCOKZBTK.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-6XK4FYL6.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-W7VBIFMT.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-L6AZMOMY.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-TUGZYOYM.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-TE27LP7N.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-TXS5HZRE.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-S4BADHOU.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-URT4I7O4.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-DUTWOO6X.js");
              return {
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-E5ZTJ2LJ.js");
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-SQTKIUBT.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-DRKKCKIT.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-DRKKCKIT.js");
...
//# sourceMappingURL=chunk-W2BVQQX6.js.map
