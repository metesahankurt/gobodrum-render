...
export default factories.createCoreController('api::article.article', ({ strapi }) => ({
  ...
  async findBySlug(ctx) {
    ...
    return (this as any).transformResponse(entity[0]);
  },
  ...
  async findByCategory(ctx) {
    ...
    return (this as any).transformResponse(articles);
  },
  ...
  async findByRouteSection(ctx) {
    ...
    type ValidRouteSection = typeof validSections[number];
    const routeSection: ValidRouteSection = validSections.includes(pathSection as ValidRouteSection) ? pathSection as ValidRouteSection : 'discover';
