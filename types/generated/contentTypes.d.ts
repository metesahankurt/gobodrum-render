...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts, news articles and content pieces for GoBodrum website';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    articleType: Schema.Attribute.Enumeration<
      ['blog', 'news', 'guide', 'review', 'interview', 'announcement']
    > &
    ...
    diningCategory: Schema.Attribute.Enumeration<
      [
        'restaurants-cafes',
        'bars-nightlife',
        'local-markets-cuisines',
        'culinary-experiences',
      ]
    >;
    discoverCategory: Schema.Attribute.Enumeration<
      [
    ...
    >;
    eventsCategory: Schema.Attribute.Enumeration<
      [
        'event-calendar',
        'music-performance',
        'sports-business',
    ...
    exploreCategory: Schema.Attribute.Enumeration<
      [
        'current-information',
        'navigation-media',
        'nature-family',
    ...
    isSticky: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    relatedArticles: Schema.Attribute.Relation<
      ...
      'api::article.article'
    >;
    routeSection: Schema.Attribute.Enumeration<
      [
        'discover',
        'things-to-do',
        'stay',
    ...
    shoppingCategory: Schema.Attribute.Enumeration<
      [
        'shopping-areas',
        'markets-crafts',
        'art-fashion',
    ...
    >;
    showInDiscoverMenu: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    stayCategory: Schema.Attribute.Enumeration<
      [
        'hotels-resorts',
        'specialized-stays',
        'bookings-planning',
    ...
    thingsToDoCategory: Schema.Attribute.Enumeration<
      [
        'activities-tours',
        'water-activities',
        'nature-wellness',
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content categories for organization and filtering';
  ...
  attributes: {
    ...
    contentCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHotelHotel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bookingCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    email: Schema.Attribute.Email;
    featuredImage: Schema.Attribute.Media<'images'>;
    hotelType: Schema.Attribute.Enumeration<
      ['hotel', 'resort', 'boutique', 'villa', 'apartment', 'hostel', 'pension']
    > &
      Schema.Attribute.DefaultTo<'hotel'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    roomTypes: Schema.Attribute.JSON;
    seasonalPricing: Schema.Attribute.JSON;
    seoDescription: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 160;
      }>;
  ...
  attributes: {
    components: Schema.Attribute.DynamicZone<
      [
        ...
        'sections.planning-cards-section',
        'sections.news-events-section',
        'sections.guides-events-section',
        'sections.beach-hero-section',
        'sections.explore-grid',
        'elements.weather-card',
      ]
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    status: Schema.Attribute.Enumeration<['draft', 'published', 'archived']> &
      Schema.Attribute.DefaultTo<'draft'>;
    template: Schema.Attribute.String & Schema.Attribute.DefaultTo<'default'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Content tags for better organization and discoverability';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['general', 'location', 'activity', 'feature', 'season', 'special']
    > &
